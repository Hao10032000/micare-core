...
if ( 'micare' == $theme->name || 'micare' == $theme->parent_theme ) {
    ...
    require THEMESFLAT_PATH . "/widgets/themesflat_recent_services.php";
...
function add_image_sizes() {
    ...
    add_image_size( 'themesflat-team-archive', 315, 315, true );

    add_image_size( 'themesflat-team-archive2', 450, 495, true );

    add_image_size( 'themesflat-service-archive1', 600, 525, true );
    add_image_size( 'themesflat-service-archive2', 465, 382, true );
    add_image_size( 'themesflat-service-archive3', 435, 405, true );

    add_image_size( 'themesflat-portfolio-single', 1935, 945, true );
    add_image_size( 'themesflat-portfolio-archive1', 685, 900, true );
    add_image_size( 'themesflat-portfolio-archive2', 615, 525, true );
...
final class ThemesFlat_Addon_For_Elementor_micare {
          ...
          add_action('elementor/element/before_section_end', function( $section, $section_id, $args ) {
            if( $section->get_name() == 'common' && $section_id == 'section_effects' ){
                ...
                $section->add_control( 
                    'heading_tfanimation',
                    [
                        'label' => esc_html__( 'TF Entrace Animation', 'themesflat-core' ),
                ...
                $section->add_control(
                    'ti_parallax', [
                        'label' => __( 'Choose Animation', 'themesflat-core' ),
                        'type' => \Elementor\Controls_Manager::SELECT,
                        'default' => '',
                        'options' => [
                            '' => esc_html__( 'Default', 'themesflat-core' ),
                            'tf-animated-item-fade' => esc_html__( 'Fade In', 'themesflat-core' ),
                            'tf-animated-item' => esc_html__( 'Fade In Up', 'themesflat-core' ),
                            'tf-animated-item-left' => esc_html__( 'Fade In Left', 'themesflat-core' ),
                            'tf-animated-item-right' => esc_html__( 'Fade In Right', 'themesflat-core' ),
                            'tf-animated-item-zoom-slide' => esc_html__( 'Zoom Slide', 'themesflat-core' ),
                            'tf-animated-item-slide-right' => esc_html__( 'Slide In Right', 'themesflat-core' ),
                        ],
                        'prefix_class' => '',
                    ]
                );
    ...
    public function init_widgets() {
        ...
        \Elementor\Plugin::instance()->widgets_manager->register( new \TFFlex_Slide_Widget_Core() );
        ...
        \Elementor\Plugin::instance()->widgets_manager->register( new \TFStepCarousel_Widget() );


        require_once( __DIR__ . '/widgets/widget-text-scroll.php' );

        \Elementor\Plugin::instance()->widgets_manager->register( new \TFTextScroll_Widget() );
        ...
        \Elementor\Plugin::instance()->widgets_manager->register( new \TFGroupFeatures_Widget() );
        ...
        \Elementor\Plugin::instance()->widgets_manager->register( new \TFAnimated_Headline_Widget() );

        require_once( __DIR__ . '/widgets/widget-sliderbeforeafter.php' );
        \Elementor\Plugin::instance()->widgets_manager->register( new \TFSliderBeforeAfter() );
        ...
        \Elementor\Plugin::instance()->widgets_manager->register( new \Custom_Swiper_Slider_Widget() );
    ...
    public function widget_styles() {
        ...
        wp_register_style( 'tfc-swiper', plugins_url( '/assets/css/swiper.css', __FILE__ ) );

        wp_register_style( 'owl-carousel', plugins_url( '/assets/css/owl.carousel.min.css', __FILE__ ) );

        wp_enqueue_style( 'tfc-animated', plugins_url( '/assets/css/tf-animated.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-piechart', plugins_url( '/assets/css/counter/tf-piechart.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-testimonial1', plugins_url( '/assets/css/testimonial/tf-testimonial.css', __FILE__ ) );

        wp_register_style( 'tf-posts-core', plugins_url( '/assets/css/posts/tf-posts.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-animated-headline', plugins_url( '/assets/css/title-section/tf-animated-headline.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-road-map', plugins_url( '/assets/css/road-map/tf-road-map.css', __FILE__ ) );

        wp_register_style( 'tf-beforeafter', plugins_url( '/assets/css/step/sliderbeforeafter.css', __FILE__ ) );
        ...
        wp_register_style( 'tf-step', plugins_url( '/assets/css/step/tf-step.css', __FILE__ ) );
         ...
         wp_register_style( 'tf-flex-slidercore', plugins_url( '/assets/css/flex-slider/tf-flexslider.css', __FILE__ ) );
    ...
    public function widget_scripts() {
        ...
        wp_register_script( 'tfc-swiper', plugins_url( '/assets/js/swiper.js', __FILE__ ), [ 'jquery' ], false, true );
        ...
        wp_enqueue_script( 'tfc-animated', plugins_url( '/assets/js/tf-animated.js', __FILE__ ), [ 'jquery' ], false, true );

        wp_enqueue_script( 'tfc-lazyload', plugins_url( '/assets/js/lazy-load.js', __FILE__ ), [ 'jquery' ], false, true );
        ...
        wp_register_script( '3rd-piechart', plugins_url( '/assets/js/counter/piechart.js', __FILE__ ), [ 'jquery' ], false, true ); 

        wp_register_script( 'tf-piechart', plugins_url( '/assets/js/counter/tf-piechart.js', __FILE__ ), [ 'jquery' ], false, true ); 

        wp_register_script( 'tf-testimonial1', plugins_url( '/assets/js/testimonial/tf-testimonial.js', __FILE__ ), [ 'jquery' ], false, true );

        wp_register_script( 'tf-step', plugins_url( '/assets/js/step/step.js', __FILE__ ), [ 'jquery' ], false, true );
        ...
        wp_register_script( 'splittext', plugins_url( '/assets/js/splittext.js', __FILE__ ), [ 'jquery' ], false, true );

        wp_register_script( 'tf-text-scroll', plugins_url( '/assets/js/tf-text-scroll.js', __FILE__ ), [ 'jquery' ], false, true );

        wp_register_script( 'tf-sliderbeforeafter', plugins_url( '/assets/js/step/sliderbeforeafter.js', __FILE__ ), [ 'jquery' ], false, true );

         // flex-slider (E Slider)

         wp_register_script( 'tf-flex-slidercore', plugins_url( '/assets/js/flex-slider/tf-flexslider.js', __FILE__ ), [ 'jquery' ], false, true );

        

        wp_enqueue_script( 'jquery-justified', plugins_url( '/assets/js/jquery.justified.min.js', __FILE__ ), [ 'jquery' ], false, true );

        wp_register_script( 'gsap', plugins_url( '/assets/js/gsap.js', __FILE__ ), [ 'jquery' ], false, true );

        wp_register_script( 'scrolltrigger', plugins_url( '/assets/js/scrolltrigger.js', __FILE__ ), [ 'jquery' ], false, true );
    ...
    ========================================= */
        ...
        public static function get_template_id( $type ) {
            ...
            $tfhf_templates = ThemesFlat_Addon_For_Elementor_micare::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
        ...
        public function tf_add_section_parallax( \Elementor\Element_Section $section ) {
            ...
            $section->add_control(
                ...
                [
                    ...
                    'label' => esc_html__( 'TF Parallax', 'themesflat-core' ),
            ...
            $section->add_control(
                ...
                [
                    ...
                    'description' => esc_html__( 'This is analogous to the background-position css property. Specify coordinates as top, bottom, right, left, center, or pixel values (e.g. -10px 0px). The parallax image will be positioned as close to these values as possible while still covering the target element.', 'themesflat-core' ),
                    ...
                    'options' => [
                        ...
                        'custom'  => esc_html__( 'Custom', 'themesflat-core' ),
            ...
            $section->add_control(
                ...
                [
                    ...
                    'label' => esc_html__( 'X Position', 'themesflat-core' ),
            ...
            $section->add_control(
                ...
                [
                    ...
                    'label' => esc_html__( 'Y Position', 'themesflat-core' ),
            ...
            $section->add_control(
                ...
                [
                    ...
                    'label' => esc_html__( 'Speed', 'themesflat-core' ),

                    'type' => \Elementor\Controls_Manager::SLIDER,

                    'description' => esc_html__( 'The speed at which the parallax effect runs. 0 means the image will appear fixed in place, and 1 the image will flow at the same speed as the page content.', 'themesflat-core' ),
            ...
            $section->add_control(
                ...
                [
                    ...
                    'label' => esc_html__( 'Bleed', 'themesflat-core' ),

                    'type' => \Elementor\Controls_Manager::NUMBER,

                    'description' => esc_html__( 'You can optionally set the parallax mirror element to extend a few pixels above and below the mirrored element. This can hide slow or stuttering scroll events in certain browsers.', 'themesflat-core' ),
...
ThemesFlat_Addon_For_Elementor_micare::instance();