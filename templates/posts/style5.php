    ...
    <div class="entry blog-post"> 
        ...
        <div class="content">
            ...
            <?php if ( $settings['show_meta'] == 'yes' ): ?> 
                ...
                <span class="post-meta post-meta-time"><a href="<?php echo get_day_link($archive_year, $archive_month, $archive_day); ?>"><i class='icon-micare-date'></i>
            ...
            <?php if ( $settings['show_button_2'] == 'yes' && $settings['button_text'] != '' ): ?>
                ...
                <div class="tf-button-container">
                    ...
                    <?php echo \Elementor\Addon_Elementor_Icon_manager_micare::render_icon( $settings['post_icon_readmore'], [ 'aria-hidden' => 'true' ] );?></a>
