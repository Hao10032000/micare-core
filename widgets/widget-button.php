		...
		// Start List Setting        
			...
			$this->add_control( 
                ...
                [
                    ...
                    'default' => esc_html__( 'Learn More Us', 'micare' ),
            ...
            $this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-button2 span' => 'color: {{VALUE}}',
            ...
            $this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-button2:hover span' => 'color: {{VALUE}}',
			...
			$this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-button2:hover, {{WRAPPER}} .tf-button2:hover::after' => 'background: {{VALUE}}',
	...
	protected function render($instance = []) {
        ...
        <div <?php echo $this->get_render_attribute_string('wrap_tf_button') ?>>
			...
			<div class="wrap-tf-button2">
				...
				<a href="<?php echo esc_url( $settings['link']['url'] ) ?>" class="tf-button2 tf-btn " >

					<span><?php echo esc_attr( $settings['button_text'] ); ?><?php echo \Elementor\Addon_Elementor_Icon_manager_micare::render_icon( $settings['post_icon_readmore'], [ 'aria-hidden' => 'true' ] );?></span> 				
