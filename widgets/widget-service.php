	        ...
	        $this->add_control( 
				...
				$this->add_control( 
					...
					[
						...
						'options' => ThemesFlat_Addon_For_Elementor_micare::tf_get_taxonomies('services_category'),
...
// /.End Carousel
		...
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}  .tf-services-wrap .featured-post img' => 'height: {{SIZE}}{{UNIT}}; !important',
                ],
            ]
        );
