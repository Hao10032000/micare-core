...
class TFPosts_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        ...
        return esc_html__( 'TF Posts Core', 'themesflat-core' );
    ...
    public function get_style_depends() {
		...
		return ['owl-carousel','tf-posts-core'];
	...
	protected function register_controls() {
        ...
        // Start Posts Query        
			...
			$this->add_control( 
				...
				[
					...
					'options' => ThemesFlat_Addon_For_Elementor_micare::tf_get_taxonomies(),
		...
		// Start Layout        
			...
			$this->add_control( 
				...
				[
					...
					'default' => 'style-layout1',

					'options' => [

						'style-layout1' => esc_html__( 'Layout 1', 'themesflat-core' ),

						'style-layout2' => esc_html__( 'Layout Mansory', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Icon Mansory Last Post ', 'micare' ),

					'type' => \Elementor\Controls_Manager::ICONS,

					'default' => [

						'value' => 'icon-micare-ona-101',
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Author Mansory Last Post', 'themesflat-core' ),

					'type' => \Elementor\Controls_Manager::TEXT,

					'default' => esc_html__( 'Rose Crawford', 'themesflat-core' ),
			...
			$this->add_control( 
				...
				[
					...
					'label' => esc_html__( 'Show Meta Author', 'themesflat-core' ),
			...
			// 		'label' => esc_html__( 'Label Author', 'themesflat-core' ),

			// 		'type' => \Elementor\Controls_Manager::TEXT,

			// 		'default' => esc_html__( 'Posted by:', 'themesflat-core' ),
			...
			$this->add_control( 
				...
				[
					...
					'label' => esc_html__( 'Show Meta Category', 'themesflat-core' ),
			...
			// 		'label' => esc_html__( 'Date Icon', 'micare' ),

			// 		'type' => \Elementor\Controls_Manager::ICONS,

			// 		'default' => [

			// 			'value' => 'icon-micare-ona-40',
        ...
        // Start General Style 
	        ...
	        $this->add_responsive_control(
				...
				[
					...
					'label' => esc_html__( 'Gap Item', 'themesflat-core' ),
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .blog-post' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .featured-post a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}}  .tf-posts .blog-post .tf-button a, {{WRAPPER}} .tf-posts .blog-post .content .tf-button-container a' => 'background-color: {{VALUE}}',
			...
			$this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .blog-post .tf-button a:hover, {{WRAPPER}} .tf-posts .blog-post .content .tf-button-container a:hover' => 'background-color: {{VALUE}}',
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .blog-post .tf-button' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .blog-post .tf-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control( 
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .tf-posts .blog-post .tf-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};overflow: hidden;',
		...
		// Start Meta Style 
	        ...
	        $this->add_group_control( 
				...
				[
					...
					'selector' => '{{WRAPPER}} .tf-posts .post-meta a, {{WRAPPER}} .tf-posts .blog-post .content .meta-post',
			...
			$this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}}  .tf-posts .blog-post .post-category a, {{WRAPPER}} .tf-posts .blog-post .content .meta-post a' => 'color: {{VALUE}}',
			...
			$this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .blog-post .post-category a:hover, {{WRAPPER}} .tf-posts .blog-post .content .meta-post a:hover' => 'color: {{VALUE}}',
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .blog-post .content .post-category' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_responsive_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tf-posts .blog-post .content .post-category' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->start_controls_section( 
			...
			[
				...
				'label' => esc_html__( 'Date', 'themesflat-core' ),
		...
		$this->add_control( 
			...
			[
				...
				'label' => esc_html__( 'Date Background', 'themesflat-core' ),

				'type' => \Elementor\Controls_Manager::COLOR,

				'selectors' => [

					'{{WRAPPER}} .tf-posts .blog-post .post-date-item ' => 'background: {{VALUE}}',
		...
		$this->add_control( 
			...
			'date_bghv_color_icon',

			[

				'label' => esc_html__( 'Date Background Hover', 'themesflat-core' ),

				'type' => \Elementor\Controls_Manager::COLOR,

				'selectors' => [

					'{{WRAPPER}} .tf-posts .blog-post:hover .post-date-item ' => 'background: {{VALUE}}',
		...
		// 		'name' => 'date_bghv_color_icon_border',

		// 		'label' => esc_html__( 'Border', 'themesflat-core' ),

		// 		'selector' => '{{WRAPPER}} .tf-posts.style1 .blog-post .post-date-item a',
		...
		$this->add_responsive_control( 
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .tf-posts .blog-post .post-date-item ' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};overflow: hidden;',
		...
		$this->add_control( 
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .tf-posts .blog-post .post-date-item a, {{WRAPPER}} .tf-posts.style1 .blog-post .post-date-item a' => 'color: {{VALUE}}',
		...
		$this->add_control( 
			...
			[
				...
				'label' => esc_html__( 'Text Color Hover', 'themesflat-core' ),

				'type' => \Elementor\Controls_Manager::COLOR,

				'selectors' => [

					'{{WRAPPER}} .tf-posts .blog-post:hover .post-date-item a, {{WRAPPER}} .tf-posts.style1 .blog-post:hover .post-date-item a' => 'color: {{VALUE}}',
	...
	protected function render($instance = []) {
		...
		$this->add_render_attribute( 'tf_posts', ['id' => "tf-posts-{$this->get_id()}", 'class' => ['tf-posts', $settings['style'], $settings['posts_layout'],$settings['style_layout'], $settings['posts_layout_tablet'], $settings['posts_layout_mobile'], $has_carousel ], 'data-tabid' => $this->get_id()] );
