	    ...
	    // Start Icon Style 
			...
			$this->add_control( 
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tficonbox .wrap-icon-inner .icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
			...
			$this->add_group_control( 
				...
				[
					...
					'selector' => '{{WRAPPER}} .tficonbox .wrap-icon-inner .icon',
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tficonbox .wrap-icon-inner .icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						...
						'{{WRAPPER}} .tficonbox .content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					...
					$this->add_control( 
						...
						[
							...
							'default' => [
								...
								'value' => 'micare-icon-long-arrow-right',
