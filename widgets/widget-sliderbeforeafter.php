...
class TFSliderBeforeAfter extends \Elementor\Widget_Base {
  ...
  {
    return esc_html__('TF Slider Before After', 'themesflat-core');
  }
  ...
  {
    return [ 'imagesloaded-pkgd','tf-jquery_event_move','tf-sliderbeforeafter'];
  }

  public function get_style_depends()
  {
    return ['tf-beforeafter'];
  }
  ...
  protected function register_controls()
  {
    $this->start_controls_section(
      'section_before',
      array(
        'label' => esc_html__('Before', 'themesflat-core'),
      )
    );
    ...
    $this->add_control(
      'before_src',
      array(
        'label' => esc_html__('Before Image Source', 'themesflat-core'),
        'type' => Controls_Manager::SELECT,
        'default' => 'media',
        'label_block' => true,
        'options' => array(
          'media' => esc_html__('Media', 'themesflat-core'),
          'url' => esc_html__('URL', 'themesflat-core'),
        ),
      )
    );
    ...
    $this->add_control(
      'before_image',
      array(
        'label' => esc_html__('Before Photo', 'themesflat-core'),
    ...
    $this->add_control(
      'before_img_url',
      array(
        'label' => esc_html__('Before Photo URL', 'themesflat-core'),
    ...
    $this->add_control(
      'before_text',
      array(
        'label' => esc_html__('Before Label', 'themesflat-core'),
        'type' => Controls_Manager::TEXT,
        'selector' => '{{WRAPPER}} .fel-infobox-title-prefix',
        'default' => esc_html__('Before', 'themesflat-core'),
        'dynamic' => array(
          'active' => true,
        ),
        'selectors' => array(
    ...
    $this->start_controls_section(
      'section_after',
      array(
        'label' => esc_html__('After', 'themesflat-core'),
      )
    );
    ...
    $this->add_control(
      'after_src',
      array(
        'label' => esc_html__('After Image Source', 'themesflat-core'),
        'type' => Controls_Manager::SELECT,
        'default' => 'media',
        'label_block' => true,
        'options' => array(
    ...
    $this->add_control(
      'after_image',
      array(
        'label' => esc_html__('After Photo', 'themesflat-core'),
        'type' => Controls_Manager::MEDIA,
        'default' => array(
          'url' => Utils::get_placeholder_image_src(),
        ),
    ...
    $this->add_control(
      'after_img_url',
      array(
        'label' => esc_html__('After Photo URL', 'themesflat-core'),
        'type' => Controls_Manager::TEXT,
        'label_block' => true,
        'separator' => 'before',
        'condition' => array(
    ...
    $this->add_control(
      'after_text',
      array(
        'label' => esc_html__('After Label', 'themesflat-core'),
        'type' => Controls_Manager::TEXT,
        'selector' => '{{WRAPPER}} .fel-infobox-title-prefix',
        'default' => esc_html__('After', 'themesflat-core'),
        'dynamic' => array(
          'active' => true,
        ),
        'selectors' => array(
    ...
    $this->start_controls_section(
      'section_style',
      array(
        'label' => esc_html__('Orientation', 'themesflat-core'),
    ...
    $this->add_control(
      'orientation',
      array(
        'label' => esc_html__('Slider Before After Orientation', 'themesflat-core'),
        'type' => Controls_Manager::CHOOSE,
        'options' => array(
          'vertical' => array(
            'title' => esc_html__('Vertical', 'themesflat-core'),
            'icon' => 'eicon-section',
          ),
          'horizontal' => array(
            'title' => esc_html__('Horizontal', 'themesflat-core'),
            'icon' => 'fa fa-columns',
          ),
        ),
        'default' => 'horizontal',
    ...
    $this->add_control(
      'move_on_hover',
      array(
        'label' => esc_html__('Move on Hover', 'themesflat-core'),
    ...
    $this->add_control(
      'overlay_color',
      array(
        'label' => esc_html__('Overlay Color', 'themesflat-core'),
    ...
    $this->start_controls_section(
      'section_handle',
      array(
        'label' => esc_html__('Comparison Handle', 'themesflat-core'),
        'tab' => Controls_Manager::TAB_LAYOUT,
      )
    );
    ...
    $this->add_control(
      'initial_offset',
      array(
        'label' => esc_html__('Handle Initial Offset', 'themesflat-core'),
        ...
        'label_block' => true,
        'options' => array(
          '0.0' => esc_html__('0.0', 'themesflat-core'),
          '0.1' => esc_html__('0.1', 'themesflat-core'),
          '0.2' => esc_html__('0.2', 'themesflat-core'),
          '0.3' => esc_html__('0.3', 'themesflat-core'),
          '0.4' => esc_html__('0.4', 'themesflat-core'),
          '0.5' => esc_html__('0.5', 'themesflat-core'),
          '0.6' => esc_html__('0.6', 'themesflat-core'),
          '0.7' => esc_html__('0.7', 'themesflat-core'),
          '0.8' => esc_html__('0.8', 'themesflat-core'),
          '0.9' => esc_html__('0.9', 'themesflat-core'),
        ),
      )
    );
    ...
    $this->add_control(
      'handle_color',
      array(
        'label' => esc_html__('Handle Color', 'themesflat-core'),
        'type' => Controls_Manager::COLOR,
        'default' => '#ffffff',
        'selectors' => array(
    ...
    $this->add_control(
      'thickness',
      array(
        'label' => esc_html__('Handle Thickness', 'themesflat-core'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('px'),
        'default' => array(
          'size' => 5,
    ...
    $this->add_control(
      'circle_width',
      array(
        'label' => esc_html__('Circle Width', 'themesflat-core'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('px'),
        'default' => array(
          'size' => 40,
    ...
    $this->add_control(
      'circle_radius',
      array(
        'label' => esc_html__('Circle Radius', 'themesflat-core'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('%'),
        'default' => array(
          'size' => 100,
    ...
    $this->add_control(
      'triangle_size',
      array(
        'label' => esc_html__('Triangle Size', 'themesflat-core'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('px'),
        'default' => array(
          'size' => 6,
    ...
    $this->start_controls_section(
      'style_section',
      array(
        'label' => esc_html__('Before/After Label', 'themesflat-core'),
    ...
    $this->add_control(
      'show_on',
      array(
        'label' => esc_html__('Show Label On', 'themesflat-core'),
        'type' => Controls_Manager::SELECT,
        'default' => 'hover',
        'label_block' => true,
        'options' => array(
          'hover' => esc_html__('Hover Only', 'themesflat-core'),
          'normal' => esc_html__('Normal Only', 'themesflat-core'),
          'both' => esc_html__('Hover & Normal', 'themesflat-core'),
        ),
