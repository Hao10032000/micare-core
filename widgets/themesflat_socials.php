...
class themesflat_socials extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__( 'Themesflat - Socials', 'micare' ),

            array(

                'classname'   => 'widget_themesflat_socials',

                'description' => esc_html__( 'Themesflat Socials.', 'micare' )
    ...
    function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'micare' ); ?></label>
        ...
        <div class="themesflat_widget_socials themesflat-options-control-social-icons">
            ...
            <ul class="themesflat_icons">
                ...
                <li class="item-properties">
                    ...
                    <button type="button" class="button button-primary confirm"><i class="icon-micare-Plus"></i></button>
    ...
    function themesflat_available_social_icons_widget() {
        ...
        $icons = apply_filters( 'themesflat_available_icons', array(
            ...
            'twitter'        => array( 'iclass' => 'icon-micare-twitter', 'title' => 'Twitter','share_link' => THEMESFLAT_PROTOCOL . '://twitter.com/intent/tweet?url=' ),

            'facebook'       => array( 'iclass' => 'icon-micare-facebook', 'title' => 'Facebook','share_link'=> THEMESFLAT_PROTOCOL . '://www.facebook.com/sharer/sharer.php?u=' ),

            'google-plus-g'    => array( 'iclass' => 'icon-micare-google-plus', 'title' => 'Google Plus','share_link'=> THEMESFLAT_PROTOCOL . '://plus.google.com/share?url=' ),

            'pinterest'      => array( 'iclass' => 'icon-micare-pinterest', 'title' => 'Pinterest','share_link' => THEMESFLAT_PROTOCOL . '://pinterest.com/pin/create/bookmarklet/?url=' ),

            'instagram'      => array( 'iclass' => 'icon-micare-instagram', 'title' => 'Instagram','share_link' => 'https://www.instagram.com/?url=' ),

            'youtube'        => array( 'iclass' => 'icon-micare-youtube', 'title' => 'Youtube','share_link' =>'' ),

            'vimeo'          => array( 'iclass' => 'icon-micare-vimeo', 'title' => 'Vimeo','share_link' =>'' ),

            'behance'        => array( 'iclass' => 'icon-micare-behance', 'title' => 'Behance','share_link' =>'' ),

            'bitcoin'        => array( 'iclass' => 'icon-micare-bitcoin', 'title' => 'Bitcoin','share_link' =>'' ),

            'digg'           => array( 'iclass' => 'icon-micare-digg', 'title' => 'Digg','share_link' =>'http://digg.com/submit?url=' ),

            'skype'          => array( 'iclass' => 'icon-micare-skype', 'title' => 'Skype','share_link' => THEMESFLAT_PROTOCOL . '://web.skype.com/share?url='),

            'slack'          => array( 'iclass' => 'icon-micare-slack', 'title' => 'Slack','share_link' => ''),

            'spotify'        => array( 'iclass' => 'icon-micare-spotify', 'title' => 'Spotify','share_link' => ''),

            'stack-overflow' => array( 'iclass' => 'icon-micare-stack-overflow', 'title' => 'Stach Overflow','share_link' => ''),
