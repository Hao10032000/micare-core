    ...
    protected function register_controls() {
        ...
        $this->add_control( 'repeater_list',
            [                   
                ...
                'default' => [
                    [
                        'headline_text_animation' => esc_html__( 'Highlighted Text 1', 'themesflat-core' ),                        
                    ],
                    [
                        'headline_text_animation' => esc_html__( 'Highlighted Text 2', 'themesflat-core' ),                        
                    ],
                    [
                        'headline_text_animation' => esc_html__( 'Highlighted Text 3', 'themesflat-core' ),                        
                    ],
                ],
