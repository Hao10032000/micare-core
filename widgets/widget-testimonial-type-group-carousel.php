...
class TFTestimonialTypeGroupCarousel_Widget extends \Elementor\Widget_Base {
			...
			$this->add_control(
				...
				[
					...
					'default' => [
						...
						'value' => 'micare-icon-quotation',

						'library' => 'micare_icon_solar_energy',
	        ...
	        $this->add_control( 
				...
				'carousel_prev_icon', [
	                ...
	                'include' => [
						...
						'icon-micare-chev-left',

						'fa fa-chevron-left',

						'fa fa-arrow-left',

						'micare-icon-long-arrow-left1',
	    	...
	    	$this->add_control( 
	    		...
	    		'carousel_next_icon', [
	                ...
	                'include' => [
						...
						'icon-micare-chev-right',

						'fa fa-chevron-right',

						'fa fa-arrow-right',

						'micare-icon-long-arrow-right2',
	...
	protected function render($instance = []) {
		...
		$icon_quote = \Elementor\Addon_Elementor_Icon_manager_micare::render_icon( $settings['icon_quote'], [ 'aria-hidden' => 'true' ] );
									...
									<div class="wrap-avatar">
										...
										<div class="avatar">
											...
											<?php if ($carousel['avatar']['id']): ?>
												...
												<img src="<?php echo esc_url(\Elementor\Group_Control_Image_Size::get_attachment_image_src( $carousel['avatar']['id'], 'thumbnail_avatar', $settings )); ?>" class="lazyload" alt="avatar">

											<?php else: ?>

												<img src="<?php echo esc_attr($carousel['avatar']['url']); ?>" class="lazyload" alt="avatar">
					...
					<div class="owl-carousel owl-theme thumbs">
					    ...
					    <div class="image-thumbs">
					    	...
					    	<?php if ($carousel['image']['id']): ?>
								...
								<img src="<?php echo esc_url(\Elementor\Group_Control_Image_Size::get_attachment_image_src( $carousel['image']['id'], 'thumbnail_image', $settings )); ?>" class="lazyload" alt="image">

							<?php else: ?>

								<img src="<?php echo esc_attr($carousel['image']['url']); ?>" class="lazyload" alt="image">
