...
class TFNavMenu_Widget_Free extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        ...
        return esc_html__( 'TF Nav Menu', 'themesflat-core' );
        ...
        // Start Menu Settings        
			...
			$this->start_controls_section( 
	            ...
	            [
	                ...
	                'label' => esc_html__('Menu Settings', 'themesflat-core'),
	        ...
	        $this->add_control(
	            ...
	            [
					...
					'label' => esc_html__('Enable one page?', 'themesflat-core'),

					'description'	=> esc_html__('This works in the current page.', 'themesflat-core'),
	        ...
	        $this->add_control(
	            ...
	            [
	                ...
	                'label'     =>esc_html__( 'Select menu', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'only-icon' => esc_html__( 'Only Icon', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Menu Panel Style', 'themesflat-core' ),
					...
					'options' => [
						...
						'menu-panel-style-default'  => esc_html__( 'Default', 'themesflat-core' ),

						'menu-panel-style-left' => esc_html__( 'Left', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Alignment Menu', 'themesflat-core' ),
	        ...
	        $this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Submenu Icon', 'themesflat-core' ),
					...
					'options' => [
						...
						'classic'  => esc_html__( 'Classic', 'themesflat-core' ),

						'arrows' => esc_html__( 'Arrows', 'themesflat-core' ),

						'plus' => esc_html__( 'Plus', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Responsive', 'themesflat-core' ),
	        ...
	        $this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Choose Mobile Menu Logo', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Link Logo', 'themesflat-core' ),
					...
					'options' => [
						...
						'home' => esc_html__( 'Home', 'themesflat-core' ),

						'custom' => esc_html__( 'Custom URL', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'URL', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[			        
			        ...
			        'label' => esc_html__('Icon Button Menu Mobile & Only Icon', 'themesflat-core'),
			...
			$this->add_control(
				...
				[			        
			        ...
			        'label' => esc_html__('Icon Close Menu', 'themesflat-core'),
        ...
        // Start Main Menu Style 
	        ...
	        $this->start_controls_section( 
	            ...
	            [
	                ...
	                'label' => esc_html__( 'Main Menu', 'themesflat-core' ),
	        ...
	        $this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Horizontal Padding', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Vertical Padding', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Link Hover Effect', 'themesflat-core' ),
					...
					'options' => [
						...
						'underline' => esc_html__( 'Underline', 'themesflat-core' ),

						'overline' => esc_html__( 'Overline', 'themesflat-core' ),

						'double-line' => esc_html__( 'Double Line', 'themesflat-core' ),

						'text' => esc_html__( 'Text', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'drop-in' => esc_html__( 'Drop In', 'themesflat-core' ),

						'drop-out' => esc_html__( 'Drop Out', 'themesflat-core' ),						
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Submenu Icon Margin', 'themesflat-core' ),
	    ...
	    // Start Dropdown Style 
	        ...
	        $this->start_controls_section( 
	            ...
	            [
	                ...
	                'label' => esc_html__( 'Dropdown', 'themesflat-core' ),
			...
			$this->add_responsive_control(
				...
				[
					...
					'label' => esc_html__( 'Dropdown Width', 'themesflat-core' ),
			...
			$this->add_responsive_control(
				...
				[
					...
					'label' => esc_html__( 'Top Distance', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label'       => esc_html__( 'Border Style', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Border First Child', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Border Last Child', 'themesflat-core' ),
	    ...
	    // Start Mobile Button & Close Icon Style 
	        ...
	        $this->start_controls_section( 
	            ...
	            [
	                ...
	                'label' => esc_html__( 'Mobile Button & Close Icon', 'themesflat-core' ),
	        ...
	        $this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Button Close', 'themesflat-core' ),
	    ...
	    // Start Menu Panel Style 
	        ...
	        $this->start_controls_section( 
	            ...
	            [
	                ...
	                'label' => esc_html__( 'Menu Panel', 'themesflat-core' ),
	        ...
	        $this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Logo', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Border Menu', 'themesflat-core' ),
			...
			$this->add_control(
				...
				[
					...
					'label' => esc_html__( 'Menu', 'themesflat-core' ),
			...
			$this->start_controls_tabs( 'panel_menu_tabs' );				
				...
				$this->add_control(
					...
					[
						...
						'label'     => esc_html__( 'Horizontal Padding Link (px)', 'themesflat-core' ),
				...
				$this->add_control(
					...
					[
						...
						'label'     => esc_html__( 'Vertical Padding Link (px)', 'themesflat-core' ),
				...
				$this->add_control(
					...
					[
						...
						'label'     => esc_html__( 'Width Icon Submenu (px)', 'themesflat-core' ),
				...
				$this->add_control(
					...
					[
						...
						'label'     => esc_html__( 'Height Icon Submenu (px)', 'themesflat-core' ),
	...
	protected function render($instance = []) {
		...
		switch ($settings['submenu_icon']) {
			...
			case 'classic':
				...
				$submenu_icon = '<i class="icon-micare-arrow-right-2" aria-hidden="true"></i>';
		...
		if ($settings['nav_menu_logo']['url']) {
			...
			if ($settings['nav_menu_logo_url_to'] == 'custom') {			
				...
				$logo = '<a href="'.$settings['nav_menu_logo_link']['url'].'" class="logo-nav"> <img src="'.$url_logo.'" class="lazyload" alt="'.get_bloginfo('name').'"> </a>';



			}else {		

				$logo = '<a href="'. esc_url(home_url('/')).'" class="logo-nav"> <img src="'.$url_logo.'" class="lazyload" alt="'.get_bloginfo('name').'"></a>';
